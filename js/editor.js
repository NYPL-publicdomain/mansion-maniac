...
(function (Mansion) {
    var Editor = (function () {
        function Editor() {
            ...
            if (persistedData)
                this.persistedData = JSON.parse(persistedData);
        ...
        Editor.prototype.drawUI = function () {
            ...
            g.f(Mansion.Config.WALL_COLOR).r(0, 0, Mansion.Config.GRID_SIZE * 4, Mansion.Config.GRID_SIZE);
            ...
            text.x = Mansion.Config.GRID_SIZE * 2;
            text.y = Mansion.Config.GRID_SIZE + 2;
            this.stage.addChild(text);
            g = new createjs.Graphics();
            g.f(Mansion.Config.WALL_COLOR).r(0, 0, Mansion.Config.GRID_SIZE * 3, Mansion.Config.GRID_SIZE);
            var wallFillButton = new createjs.Shape(g);
            wallFillButton.name = "wall";
            wallFillButton.cursor = "pointer";
            wallFillButton.x = Mansion.Config.GRID_SIZE * 6;
            wallFillButton.y = Mansion.Config.GRID_SIZE;
            this.stage.addChild(wallFillButton);
            wallFillButton.on("click", this.handleFillButtonClick, this);
            text = new createjs.Text("Fill", "16px Arial", Mansion.Config.DELETE_COLOR);
            text.x = Mansion.Config.GRID_SIZE * 7;
            text.y = Mansion.Config.GRID_SIZE + 2;
            this.stage.addChild(text);
            g = new createjs.Graphics();
            g.f(Mansion.Config.FLOOR_COLOR).r(0, 0, Mansion.Config.GRID_SIZE * 4, Mansion.Config.GRID_SIZE);
            ...
            this.stage.addChild(text);
            g = new createjs.Graphics();
            g.f(Mansion.Config.FLOOR_COLOR).r(0, 0, Mansion.Config.GRID_SIZE * 3, Mansion.Config.GRID_SIZE);
            var floorFillButton = new createjs.Shape(g);
            floorFillButton.name = "floor";
            floorFillButton.cursor = "pointer";
            floorFillButton.x = Mansion.Config.GRID_SIZE * 6;
            floorFillButton.y = Mansion.Config.GRID_SIZE * 2;
            ...
            this.stage.addChild(text);
            g = new createjs.Graphics();
            g.f(Mansion.Config.DOOR_COLOR).r(0, 0, Mansion.Config.GRID_SIZE * 4, Mansion.Config.GRID_SIZE);
            ...
            this.stage.addChild(text);
            g = new createjs.Graphics();
            g.f(Mansion.Config.DELETE_COLOR).r(0, 0, Mansion.Config.GRID_SIZE * 4, Mansion.Config.GRID_SIZE);
        ...
        Editor.prototype.handleFillButtonClick = function (event) {
            this.updateCursor(event.target.name);
            var i, j;
            var bounds = this.roomContainer.getBounds();
            var maxTileX = Math.floor(bounds.width / Mansion.Config.GRID_SIZE);
            var maxTileY = Math.floor(bounds.height / Mansion.Config.GRID_SIZE);
            var tiles = this.roomItems[this.currentRoom].tiles;
